...
@section('contents')
<h1 class="font-bold text-2xl ml-3">Add Lead</h1>
<hr />
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <form action="{{ route('admin/lead/store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="sm:col-span-4">
                <label class="block text-sm font-mediu/m leading-6 text-gray-900">Name</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                    <input id="products" name="products" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="sm:col-span-4">
